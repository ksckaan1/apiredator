...
<div>
	<div class="grid grid-cols-[8rem_1fr_1fr_3rem] border-b border-white/20">
	...
	{#each rows as row, i}
		<div
			class="rw grid w-full grid-cols-[8rem_1fr_1fr_3rem] border-b px-3 border-white/20 items-center"
		>
	...
	{/each}
	<div
		class="grid w-full grid-cols-[8rem_1fr_1fr_3rem] border-b px-3 border-white/20 items-center"
	>
		<span></span>
		<input
			bind:this={keyInput}

...
export const ayuTheme: monaco.editor.IStandaloneThemeData = {
  base: "vs-dark",
  inherit: true,
  colors: {
  ...
  rules: [
    { token: "comment", fontStyle: "italic", foreground: "#acb6bf8c" },
    { token: "string", foreground: "#aad94c" },
    { token: "constant.other.symbol", foreground: "#aad94c" },
    { token: "constant.numeric", foreground: "#95e6cb" },
    ...
    { token: "variable.language", fontStyle: "italic", foreground: "#39bae6" },
    { token: "keyword", foreground: "#ff8f40" },
    { token: "keyword.operator", foreground: "#f29668" },
    { token: "punctuation.separator", "foreground": "#bfbdb6b3" },
    { token: "punctuation.terminator", "foreground": "#bfbdb6b3" },

					...
					<div class="w-full mx-auto max-w-7xl px-5">
						<div in:fly={{ duration: 200, delay: 600, y: -50 }}>
							<div class="flex justify-between">
								<div>
									<div
										class="text-3xl text-white/70 mb-2 font-light"
									>
										{bookmarkData?.title}
									</div>
									<div class="mt-2 text-white/30 font-light">
										{new Date(
											bookmarkData?.create_at,
										).toString()}
									</div>
									<div
										class="mb-3 flex flex-wrap gap-3 items-center"
									>
										<Icon
											icon="mdi:tags"
											width="20"
							...
							<div class="flex gap-2 items-center">
								<UrlInfo
									requestMethod={bookmarkData?.request.method}
									requestURL={bookmarkData?.request.url}
								/>
						...
						<StatusTiles
							...
							numberOfRequests={bookmarkData?.options
								.number_of_requests}
							numberOfClients={bookmarkData?.options
								.number_of_clients}
							...
							avgRPS={Number(
								bookmarkData?.stat.rps.avg.toFixed(2),
							)}
